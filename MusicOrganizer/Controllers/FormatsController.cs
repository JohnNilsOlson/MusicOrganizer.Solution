...
namespace MusicOrganizer.Controllers
{
  public class FormatsController : Controller
  {
    ...
    public ActionResult Create(int formatId, string recordTitle, string recordArtist, string recordGenre, string recordReleaseDate)
    {
      Dictionary<string, object> model = new Dictionary<string, object>();
      Format foundFormat = Format.Find(formatId);
      Record newRecord = new Record(recordTitle, recordArtist, recordGenre, recordReleaseDate);
      newRecord.Save();
